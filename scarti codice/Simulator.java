...
public class Simulator {
    ...
    public static void main(String[] args) { //start point of the program execution
        ...
        t.current    = START;
        event[0].t   = sim.getArrivalServer(r,  1); //first arrival to the server node
        event[0].x   = 1;
        ...
        while (event[0].x != 0) {
            ...
            if (e == 0) { //arrivo al server
                ...
                if (numberJobsServerOrder <= ) {                                   //if there is only one job in the node, schedule a completion (ci sono due job in coda all'inizio)
                ...
                numberJobsServerOrder++;
                event[0].t        = sim.getArrivalServer(r, 1);
            }
            ...
            else if(numberJobsPickingCenter > 0 && e == ALL_EVENTS - 5){
                numberJobsPickingCenter--;
                abandonedPicking++;
            ...
            else if(numberJobsPackingCenter > 0 && e == ALL_EVENTS - 4){
            ...
            else if( numberJobsQualityCenter > 0 && e == ALL_EVENTS - 3){
                numberJobsQualityCenter--;
                abandonedQuality++;
                event[e].t = t.current + sim.getAbandon(PATIENCE, r, 0);
            ...
            else if( numberJobsShippingCenter > 0 && e == ALL_EVENTS - 2){
                numberJobsShippingCenter--;
            ...
            else if(numberJobsShippingCenter > 0 && e == ALL_EVENTS - 1){
                numberJobsShippingCenter--;
            ...
            /*if(numberJobsPickingCenter > 0 && numberJobsPickingCenter <= SERVERS_PICKING){
                event[ALL_EVENTS- 5].x = 1;
            }
            else{
                event[ALL_EVENTS- 5].x = 0;
            }
            if(numberJobsPackingCenter > 0 && numberJobsPackingCenter > SERVERS_PACKING ){
                event[ALL_EVENTS- 4].x = 1;
            }
            else{
                event[ALL_EVENTS- 4].x = 0;
            }
            if(numberJobsQualityCenter > 0 && numberJobsQualityCenter > SERVERS_QUALITY){
                event[ALL_EVENTS- 3].x = 1;
            }
            else{
                event[ALL_EVENTS- 3].x = 0;
            }
            if(numberJobsShippingCenter > 0 && numberJobsShippingCenter > SERVERS_SHIPPING){
                event[ALL_EVENTS- 2].x = 1;
                event[ALL_EVENTS- 1].x = 1;
            }
            else{
                event[ALL_EVENTS- 2].x = 0;
                event[ALL_EVENTS- 1].x = 0;
            }*/
    ...
    private double getArrivalServer(Rngs r, int streamIndex) {
        /* --------------------------------------------------------------
