...
public class SimulatorParameters {
    ...
    public static final int    SERVERS_SORTING_FRAGILE_ORDERS = 10;              /* number of servers        10-20-30      */
    public static final int    SERVERS_SORTING_NOT_FRAGILE_ORDERS = 10;              /* number of servers        10-20-30      */
    ...
    public static final int EVENT_ARRIVAL_FRAGILE_QUALITY = EVENT_DEPARTURE_PACKING + 1;
    public static final int EVENT_ARRIVAL_NOT_FRAGILE_QUALITY = EVENT_DEPARTURE_PACKING + 2;
    public static final int EVENT_DEPARTURE_QUALITY = (EVENT_ARRIVAL_NOT_FRAGILE_QUALITY + 1) + SERVERS_QUALITY;
    ...
    public static final double SERVICE_TIME_SORTING_FRAGILE_ORDERS = 90;
    public static final double SERVICE_TIME_SORTING_NOT_FRAGILE_ORDERS = 90;
